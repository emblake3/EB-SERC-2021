...
>>>>>>> a9e52a08b0d53a43f179913b9f9f6f5d57bdc345
```
...
g33 <- g3 + theme(panel.background = element_blank(), panel.grid.major = element_blank(), panel.grid.minor = element_blank(), axis.line = element_line(colour = "black"))
```
=======
    xlab("Area type") + ylab("Percent Damage") +
...
##Herb Income
g6 <- ggplot(data = barGraphStats(data = damage3, variable = "herbivore", byFactorNames = c("Income")), aes(x=Income, y=mean, fill=Income)) +
   geom_bar(stat='identity', position=position_dodge()) +
    geom_errorbar(aes(ymin=mean-se, ymax=mean+se), width = 0.2, position = position_dodge(0.9)) +
scale_fill_manual(values = EBpalette1) + xlab("Income") + ylab("Abundance") + theme(legend.position = "none")


##Pred Income
g7 <- ggplot(data = barGraphStats(data = damage3, variable = "predator", byFactorNames = c("Income")), aes(x=Income, y=mean, fill=Income)) +
    geom_bar(stat='identity', position=position_dodge()) +
    geom_errorbar(aes(ymin=mean-se, ymax=mean+se), width = 0.2, position = position_dodge(0.9)) +
scale_fill_manual(values = EBpalette1) + xlab(" Income") + ylab("Abundance") + theme(legend.position = "none")
